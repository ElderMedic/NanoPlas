...
def basecall_qc(sub_dir, fastq_file)->"ListOutput":
    ...
    # command_fastqc = ['fastqc', 
                        ...
                        # f'{fastq_file}',
                        # '-t', '6',
                        # ] # higher thread num alleviate mem allocation problem
    ...
    # process_fastqc = list(run_command(command_fastqc))
...
def assembly(sub_dir, fastq_file, dir_name, pipeline_config)->"ListOutput":
    ...
    # for dir_name in dirs:
        ...
        #     if dir_name in selected_barcode: # if barcode is selected
            ...
            if 'mergefq' not in skip_list:
                process_mergefq, process_nanoplot = basecall_qc(sub_dir, fastq_file)
